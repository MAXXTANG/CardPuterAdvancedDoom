...
{
    _g->players[_g->consoleplayer].cheats ^= CF_GODMODE;

    if(_g->players[_g->consoleplayer].cheats & CF_GODMODE)
    {
        _g->players[_g->consoleplayer].health = god_health;

        _g->players[_g->consoleplayer].message = STSTR_DQDON;
    }
    else
    {
        _g->players[_g->consoleplayer].message = STSTR_DQDOFF;
...
{
    _g->players[_g->consoleplayer].weaponowned[wp_chainsaw] = true;
    _g->players[_g->consoleplayer].pendingweapon = wp_chainsaw;

    P_GivePower(&_g->players[_g->consoleplayer], pw_invulnerability);

    _g->players[_g->consoleplayer].message = STSTR_CHOPPERS;
}
...
static void cheat_idkfa()
{
    ...
    player_t* plyr = &_g->players[_g->consoleplayer];
...
{
    _g->players[_g->consoleplayer].cheats ^= CF_NOCLIP;

    if(_g->players[_g->consoleplayer].cheats & CF_NOCLIP)
    {
        _g->players[_g->consoleplayer].message = STSTR_NCON;
    }
    else
    {
        _g->players[_g->consoleplayer].message = STSTR_NCOFF;
...
{
    P_GivePower(&_g->players[_g->consoleplayer], pw_strength);
}

static void cheat_invisibility()
{
    P_GivePower(&_g->players[_g->consoleplayer], pw_invisibility);
}

static void cheat_map()
{
    P_GivePower(&_g->players[_g->consoleplayer], pw_allmap);
}

static void cheat_goggles()
{
    P_GivePower(&_g->players[_g->consoleplayer], pw_infrared);
}
...
{
    _g->players[_g->consoleplayer].cheats ^= CF_ENEMY_ROCKETS;

    if(_g->players[_g->consoleplayer].cheats & CF_ENEMY_ROCKETS)
    {
        _g->players[_g->consoleplayer].health = god_health;

        _g->players[_g->consoleplayer].weaponowned[wp_missile] = true;
        _g->players[_g->consoleplayer].ammo[am_misl] = _g->players[_g->consoleplayer].maxammo[am_misl];

        _g->players[_g->consoleplayer].pendingweapon = wp_missile;

        _g->players[_g->consoleplayer].message = STSTR_ROCKETON;
    }
    else
    {
        _g->players[_g->consoleplayer].message = STSTR_ROCKETOFF;
    }
}
...
static void cheat_fps()
{
	...
	if(_g->fps_show)
	{
		_g->players[_g->consoleplayer].message = STSTR_FPSON;
	}else
	{
		_g->players[_g->consoleplayer].message = STSTR_FPSOFF;
	}
}